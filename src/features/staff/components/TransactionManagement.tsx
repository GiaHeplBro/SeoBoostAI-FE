...
export function TransactionManagement() {
    ...
    const { data: usersData, isLoading: loadingUsers } = useQuery<UserFilterResponse>({
        queryKey: ['staff-tx-users', userCurrentPage],
    ...
    const { data: txDetails, isLoading: loadingDetails } = useQuery<Transaction>({
        queryKey: ['staff-transaction-details', detailsDialog.transactionId],
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Xem các giao dịch của người dùng</p>
                </div>
                                            ...
                                            <tr key={user.userID} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center justify-center">
                                                        {/* Only View Transactions button, NO Deposit button */}
            ...
            {/* Selected User Transactions - NO DEPOSIT BUTTON */}
            {viewMode === 'users' && selectedUser && (
                <div className="space-y-4">
                    <div className="flex items-center gap-4 bg-blue-50 rounded-xl p-4 border border-blue-200">
                        ...
                        <div className="ml-auto text-right">
                            ...
                            <p className="font-mono font-semibold text-green-600">{formatCurrency(selectedUser.currency)}</p>
                        </div>
                    </div>
